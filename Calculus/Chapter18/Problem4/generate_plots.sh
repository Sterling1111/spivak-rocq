...
FOLDER="Calculus/Chapter18/Problem4"
COQ_FILE="Calculus/Chapter18/Problem4.v"
VO_FILE="Calculus/Chapter18/Problem4.vo"

echo "Generating PNG plots for chapter 18 problem 4..."

if ! command -v gnuplot >/dev/null 2>&1; then
    echo "gnuplot not found; skipping plot generation for chapter 18 problem 4." >&2
    exit 0
fi
